...
<article class="single-post" id="post-<?php the_ID();?>" <?php post_class();?>>
    <div class="single-page-top">
        <h3 id="single-title"><?php the_field('for_rent_property_title');?></h3>
        <div class="sale-price">
            <p class="pricefor"><?php the_field('for_rent');?></p>
        ...
        <div class="col-xs-12 col-sm-8">
            <div class="first-col-1">
                <div class="more-property-information">
                    <div class="id-style">
                        <p>Property ID: <p class="id-color"> <?php the_field('for_rent_property_id');?></p>
                        </p>
                    </div>
                    <hr id="line-style">
	...
	c1.104,0,2-0.896,2-2C24,21.262,23.596,20.624,23,20.277z"></path>
		...
		c0-1.104,0.896-2,2-2h1v1c0,0.552,0.447,1,1,1s1-0.448,1-1V4h10v1c0,0.552,0.447,1,1,1s1-0.448,1-1V4h1c1.104,0,2,0.896,2,2V20z">
                            ...
                            <?php the_field('for_rent_property_year_built');?>
                        </div>
                        <div class="lot-size">
                            <p>Lot Size</p>
                            ...
                            <?php the_field('for_rent_property_lot_size');?>
                        </div>
                    </div>
                    <div class="single-description">
                        <h6 class="desc-font-style">Description</h6>
                        <p class="desc-paragraph"><?php the_field('for_rent_property_description');?></p>
                    </div>
                    <div>
                        <h6 class="desc-font-style">Common Note</h6>
                        <p class="note-paragraph"><?php the_field('for_rent_property_common_note');?></p>
                    </div>
                    <div>
                        <h6 class="desc-font-style">Property Video</h6>
                        <p class="vid-style"><?php the_field('for_rent_property_video');?></p>
                    </div>
                </div>
            </div>
            <h6 class="desc-font-style-map">Property on Map</h6>
            <iframe class="map-style" src="<?php the_field('google_map_for_rent');?>"></iframe>
