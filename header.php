...
<body>
    ...
    <div class="modal fade bd-example-modal-lg" id="loginModal" tabindex="-1" role="dialog" aria-labelledby="loginModalCenter" aria-hidden="true">
                ...
                <div class="modal-body">
                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-6" >
                                <!-- Default form login -->
                                <form class="text-center" id="loginForm" action="<?php echo get_template_directory_uri(); ?>/login.php" method="post">

                                    <p class="h4 mb-4">Sign in</p>

                                    <!-- Username or Email -->
                                    <input type="text" id="defaultLoginFormEmail" class="form-control mb-4" name="usermail" placeholder="Username or E-mail">
                                    ...
                                    <!-- Login button -->
                                    <button class="btn btn-info btn-block my-4" type="submit" name="login-submit">Login</button>
                                ...
                                <form class="text-center" id="registerForm" action="<?php echo get_template_directory_uri(); ?>/register.php" method="post">
                                    ...
                                    <div class="form-row mb-4">
                                        <div class="col">
                                            <!-- User name -->
                                            <input type="text" id="defaultRegisterFormUserName" class="form-control" name="username" placeholder="Username">
                                        </div>
                                    </div>

                                    <!-- E-mail -->
                                    <input type="text" id="defaultRegisterFormEmail" class="form-control mb-4" name="email" placeholder="E-mail">

                                    <!-- Password -->
                                    <input type="password" id="defaultRegisterFormPassword" class="form-control" name="pwd" placeholder="Password" aria-describedby="defaultRegisterFormPasswordHelpBlock">
                                    ...
                                    <!-- Newsletter -->
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" id="defaultRegisterFormNewsletter" name="subscribe" value=1>
